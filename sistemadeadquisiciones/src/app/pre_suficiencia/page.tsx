...
import Pie from '../pie';
import TablaSolicitudes from './tablaPreSuficiencia';
import AltaSolicitud from './formularios/alta';
// import { fetchSolicitudesDetalles } from './peticionPreSuficiencia';
  ...
  return (
    <div>
      ...
      <div className="min-h-screen p-4" style={{ marginTop: 150 }}>
        <h1 className="text-2xl text-center font-bold mb-4">Solicitud de la pre - suficiencia</h1>

        {loading && <p>Cargando solicitudes...</p>}
        {error && <p>Error: {error}</p>}

        {/* <TablaSolicitudes solicitudes={detallesSolicitud ?? { solicitud: null, justificacion: null, techoPresupuestal: null }} onSolicitudAdded={fetchSolicitudesDetalles} /> */}
