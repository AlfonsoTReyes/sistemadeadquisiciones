...
export async function GET(req: NextRequest) {
  ...
  console.log("API ROUTE GET /admin/proveedores (Docs/Comments):", Object.fromEntries(searchParams.entries()));
  ...
  try {
      ...
      if (idDocParaComentarios) {
          ...
          console.log(`API ROUTE GET: Calling service obtenerComentariosPorDocumento(${idDocumento})`);
      ...
      // --- CASO 2: Obtener Documentos de un Proveedor ---
          ...
          console.log(`API ROUTE GET: Calling service obtenerDocumentosPorProveedor(${providerIdNum})`);
...
export async function PUT(req: NextRequest) {
    console.log("API ROUTE PUT /admin/proveedores: Request for document status update received.");
    try {
        ...
        console.log(`API ROUTE PUT: Calling service updateEstatusDocumentoProveedor(${id_documento_proveedor}, ${nuevoEstatus})`);
...
export async function POST(req: NextRequest) {
  try {
      const data = await req.json();
      console.log("API Route POST /admin/proveedores (Comment) received:", data);
      ...
      // }
      // console.log("ID Admin autenticado:", idUsuarioAdminReal);
      // ------------------------------------------------------------------
      ...
      console.log(`API ROUTE POST: Handling create comment for doc ID ${id_documento_proveedor} by admin ID ${id_usuario_admin}`); // O usa idUsuarioAdminReal
...
export async function DELETE(req: NextRequest) {
     try {
        ...
        console.log(`API Route DELETE /admin/proveedores - Request to delete comment ID: ${idComentario}`);
