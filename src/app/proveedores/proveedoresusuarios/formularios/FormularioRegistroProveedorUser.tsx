...
const FormularioRegistroProveedorUser = () => {
    const {
        ...
        signupApellidoPaterno, setSignupApellidoPaterno, // Added
        signupApellidoMaterno, setSignupApellidoMaterno, // Added
      ...
      <form onSubmit={handleProveedorSignup} className="space-y-4 p-6 bg-white shadow-md rounded-lg">
        ...
        {successMessage && <p className="text-green-600 text-sm text-center">{successMessage}</p>}
         ...
         <div>
          ...
          <input type="text" id="signup-apellido-materno" value={signupApellidoMaterno} onChange={handleInputChange(setSignupApellidoMaterno)} className="mt-1 block w-full input-style" />
        </div>
         <div>
