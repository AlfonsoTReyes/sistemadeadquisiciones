            ...
            <li className="mb-1">
              ...
              {isSecretariasOpen && (
                <ul className="ml-4 mt-1 space-y-1 bg-gray-700 rounded-md p-2">
                  ...
                  {permissions.includes('menu_ver_ordenes_compra_secretarias') && (<li className="mb-1"><Link href="/m" onClick={() => setIsOpen(false)} className="flex items-center text-white hover:bg-[#faa21b] px-4 py-2 rounded-md"><FontAwesomeIcon icon={faClipboardList} className="mr-2 w-5" /> Ordenes de compra</Link></li>)}
                  {permissions.includes('menu_ver_recepcion_articulo_secretarias') && (<li className="mb-1"><Link href="/m" onClick={() => setIsOpen(false)} className="flex items-center text-white hover:bg-[#faa21b] px-4 py-2 rounded-md"><FontAwesomeIcon icon={faClipboardList} className="mr-2 w-5" /> Recepción de articulos</Link></li>)}
                  {permissions.includes('menu_ver_seguimientos_secretarias') && (<li className="mb-1"><Link href="/m" onClick={() => setIsOpen(false)} className="flex items-center text-white hover:bg-[#faa21b] px-4 py-2 rounded-md"><FontAwesomeIcon icon={faClipboardList} className="mr-2 w-5" /> Seguimientos</Link></li>)}
            ...
            <li className="mb-1">
              ...
              {isFinanzasOpen && (
                <ul className="ml-4 mt-1 space-y-1 bg-gray-700 rounded-md p-2">
                  ...
                  {permissions.includes('menu_ver_comite') && (<li className="mb-1"><Link href="/usuarios_comite" onClick={() => setIsOpen(false)} className="flex items-center text-white hover:bg-[#faa21b] px-4 py-2 rounded-md"><FontAwesomeIcon icon={faClipboardCheck} className="mr-2 w-5" /> Mis Comités</Link></li>)}
                  {/* ... otros links ... */}
                </ul>
              )}
            </li>
